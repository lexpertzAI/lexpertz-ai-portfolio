...
export const FounderSection = () => {
  return (
    <section className="relative py-24 px-6 overflow-hidden" id="about">
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[500px] h-[500px] bg-cyan-500/10 rounded-full blur-[120px] -z-10" />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="md:col-span-5 relative group">
            <div className="absolute inset-0 bg-gradient-to-tr from-cyan-500 to-blue-600 rounded-2xl blur opacity-40 group-hover:opacity-60 transition duration-500" />
            <div className="relative h-[500px] w-full bg-zinc-900 rounded-2xl border border-white/10 overflow-hidden flex flex-col items-center justify-end">
              <Image 
                src="/founder.jpg" 
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black via-black/80 to-transparent z-10">
                ...
                <p className="text-cyan-400 text-xs uppercase tracking-widest mb-2">Senior AI Engineer</p>
          ...
          <div className="md:col-span-7 space-y-8">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-cyan-400 text-xs font-bold mb-4 uppercase tracking-wider">
              ...
              <p className="text-lg text-zinc-400 leading-relaxed border-l-2 border-cyan-500/20 pl-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-zinc-900/50 border border-white/5 hover:border-cyan-500/30 transition group">
                <Workflow className="text-cyan-500 mb-2 group-hover:scale-110 transition" size={20} />
              ...
              <div className="p-4 rounded-xl bg-zinc-900/50 border border-white/5 hover:border-cyan-500/30 transition group">
                <Activity className="text-green-500 mb-2 group-hover:scale-110 transition" size={20} />
              ...
              <div className="p-4 rounded-xl bg-zinc-900/50 border border-white/5 hover:border-cyan-500/30 transition group">
                <TrendingUp className="text-purple-500 mb-2 group-hover:scale-110 transition" size={20} />
              ...
              <div className="p-4 rounded-xl bg-zinc-900/50 border border-white/5 hover:border-cyan-500/30 transition group">
                <BrainCircuit className="text-blue-500 mb-2 group-hover:scale-110 transition" size={20} />
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link 
                ...
                target="_blank"
                className="flex items-center gap-2 px-6 py-3 rounded-lg bg-white text-black font-bold hover:bg-cyan-400 transition"
              >
